 ...
 * dans la langue choisie par l'utilisateur (fr / ar / darija).
 *
...
const FOOTER = {
  ...
  ar: "One Click BP — وثيقة تم إنشاؤها تلقائياً، يجب التحقق من الفرضيات مع خبير محاسب معتمد.",
...
const T = {
  ...
  ar: {
    ...
    guideIntroTitle: "مقدمة", guideCommentLireTitle: "كيف تقرأ هذه الوثيقة؟",
    guideGlossaireTitle: "المعجم", guideConseilsTitle: "نصائح",
    guideErreursTitle: "أخطاء شائعة يجب تجنبها",
    termeCol: "المصطلح", definitionCol: "التعريف",
    identiteTitle: "هوية المشروع", nomProjetLbl: "اسم المشروع",
    secteurLbl: "قطاع النشاط", villeLbl: "المدينة", formeJuridiqueLbl: "الشكل القانوني",
    resumeNarratifTitle: "ملخص وصفي",
    marche_ville: "المدينة المستهدفة", marche_region: "الجهة",
    marche_portee: "نطاق السوق", marche_clientele: "الزبناء المستهدفون",
    marche_type: "نوع السوق", marche_taille: "الحجم التقديري للسوق (درهم/سنة)",
    marche_tendances: "الاتجاهات الملاحظة في القطاع", marche_saisonnalite: "هل القطاع موسمي؟",
    marche_facteurs: "أهم العوامل المؤثرة على الطلب",
    clients_profil: "الملف النموذجي للزبون", clients_age: "الفئة العمرية المستهدفة",
    clients_localisation: "موقع الزبناء", clients_pouvoirAchat: "القدرة الشرائية للفئة المستهدفة",
    clients_besoins: "أهم احتياجات الزبناء", clients_frequence: "وتيرة الشراء المقدرة",
    clients_panier: "متوسط سلة الشراء المقدر", clients_nbClients: "عدد الزبناء المتوقع (السنة 1)",
    clients_croissance: "نسبة نمو عدد الزبناء (%/سنة)", clients_methode: "طريقة اكتساب الزبناء",
    produits_nom: "الاسم", produits_description: "الوصف", produits_prix: "سعر البيع للوحدة",
    produits_cout: "التكلفة المباشرة للوحدة", produits_qte: "الكمية المباعة / شهرياً",
    produits_freq: "عدد أشهر البيع في السنة", produits_marge: "الهامش المرغوب (%)", produits_ca: "رقم الأعمال السنوي",
    totalLbl: "المجموع", produits_aucun: "لم يتم إدخال أي منتج/خدمة مفصلة في الاستمارة.",
    concurrence_question: "هل تم تحديد منافسين؟",
    concurrence_nom: "الاسم", concurrence_prix: "الأثمنة المعتمدة", concurrence_avantages: "المزايا",
    concurrence_faiblesses: "نقاط الضعف", concurrence_positionnement: "التموقع المرغوب",
    concurrence_avantageConcurrentiel: "الميزة التنافسية المعتمدة",
    concurrence_aucun: "لم يتم بعد تحديد أي منافس من طرف صاحب المشروع. يُنصح بإجراء دراسة ميدانية قبل ضبط التموقع التجاري النهائي — يجب عدم الاعتماد على منافسين افتراضيين.",
    marketing_methode: "طريقة الاكتساب المرتقبة (مستخرجة من قسم الزبناء)",
    marketing_conseilsTitle: "ممارسات جيدة للتسويق في السوق المغربية",
    marketing_tips: [
      "الحضور الرقمي : صفحة فيسبوك/إنستغرام وبطاقة Google Business لتكون مرئياً محلياً.",
      "WhatsApp Business : للتواصل مع الزبناء، استقبال الطلبات وإرسال التذكيرات.",
      "شراكات محلية : مع تجار أو جمعيات الحي لكسب الظهور بتكلفة أقل.",
      "التوصية الشفهية وآراء الزبناء : يجب تشجيعها بشكل فعال (نظام الإحالة، طلب التقييمات عبر الإنترنت).",
    ],
    rh_poste: "المنصب", rh_nombre: "العدد", rh_salaire: "الأجر الإجمالي الشهري",
    rh_coutAnnuel: "التكلفة السنوية للمشغل (تقديرية)", rh_date: "تاريخ التوظيف المرتقب",
    rh_aucun: "لم يتم إدخال أي منصب مفصل. تم اعتماد الكتلة الأجرية من المبلغ الإجمالي المدخل في مرحلة التكاليف (انظر ورقة الفرضيات).",
    invest_local: "المحل (الاقتناء، حق الدخول)", invest_travaux: "الأشغال / التهيئة",
    invest_equipement: "التجهيزات", invest_machines: "الآلات", invest_informatique: "العتاد المعلوماتي",
    invest_mobilier: "الأثاث", invest_vehicule: "السيارة", invest_logiciels: "البرمجيات",
    invest_licences: "التراخيص / الاعتمادات", invest_stock: "المخزون الأولي",
    invest_communication: "تواصل الانطلاقة", invest_frais: "مصاريف تأسيس المقاولة",
    invest_autres: "استثمارات أخرى", invest_totalLbl: "مجموع الاستثمار",
    posteCol: "البند", montantCol: "المبلغ (درهم)",
    financement_emplois: "الاستعمالات (الاحتياجات)", financement_ressources: "الموارد (التمويل)",
    financement_surplus: "مواردكم تغطي احتياجاتكم، مع فائض قدره",
    financement_deficit: "مواردكم لا تغطي بعد احتياجاتكم : ينقصكم",
    financement_deficitSuite: "يجب تمويلها عبر مكمل (مساهمة، قرض أو إعانة إضافية).",
    charges_loyer: "الكراء السنوي", charges_electricite: "الكهرباء", charges_eau: "الماء",
    charges_internet: "الأنترنيت", charges_telecommunications: "الاتصالات",
    charges_marketing: "التسويق / التواصل", charges_transport: "النقل",
    charges_assurance: "التأمين", charges_comptabilite: "المحاسبة / خبير المحاسبة",
    charges_logiciels: "اشتراكات البرمجيات", charges_maintenance: "الصيانة",
    charges_matieresPremiere: "المواد الأولية / اللوازم", charges_fraisBancaires: "المصاريف البنكية",
    charges_taxes: "رسوم متنوعة", charges_autres: "تكاليف أخرى", charges_salaires: "الأجور (غير مفصلة في الموارد البشرية)",
    charges_totalLbl: "مجموع التكاليف المدخلة", charges_comparaisonTitle: "تكاليف حساب النتائج التوقعي (للمقارنة)",
    treso_mois: "الشهر", treso_encCA: "مداخيل رقم الأعمال (شاملة الضريبة)", treso_encFin: "مداخيل التمويل",
    treso_totEnc: "مجموع المداخيل", treso_chgExt: "مصاريف التكاليف الخارجية",
    treso_chgPers: "مصاريف الأجور", treso_invest: "مصاريف الاستثمار",
    treso_tva: "الضريبة على القيمة المضافة الواجب أداؤها", treso_totDec: "مجموع المصاريف", treso_fluxNet: "التدفق الصافي الشهري",
    treso_solde: "الرصيد التراكمي للخزينة", treso_graphTitle: "تطور الرصيد التراكمي (تمثيل بأشرطة البيانات)",
    bfr_montantLbl: "الحاجة إلى رأس المال العامل المقدرة", bfr_delaiClientsLbl: "أجل أداء الزبناء المعتمد",
    bfr_delaiFournLbl: "أجل أداء الموردين المعتمد", bfr_stockJoursLbl: "المخزون المتوسط المعتمد",
    bfr_joursUnit: "يوماً",
    seuil_montantLbl: "رقم الأعمال الواجب تحقيقه (عتبة الربحية)",
    seuil_joursLbl: "عدد الأيام للوصول لهذه العتبة (السنة 1)",
    seuil_atteintOui: "يمكن بلوغ هذه العتبة منذ السنة الأولى من النشاط.",
    seuil_atteintNon: "لن يتم بلوغ هذه العتبة خلال السنة الأولى وفق الفرضيات الحالية.",
    seuil_nonCalculable: "لا يمكن حساب عتبة الربحية بالمعطيات الحالية (هامش على التكاليف المتغيرة معدوم أو سلبي).",
    ratios_infoCol: "مؤشر مرجعي",
    scenario_caLbl: "رقم الأعمال (السنة 1)", scenario_rnLbl: "الربح الصافي (السنة 1)",
...
const PF_LABELS_TR = {
  ar: {
    "Immobilisations (matériel, agencements...)": "التجهيزات الثابتة (معدات، تهيئات...)",
    "Frais de constitution / établissement": "مصاريف التأسيس",
    "Besoin en Fonds de Roulement (BFR) de démarrage": "الحاجة إلى رأس المال العامل عند الانطلاق",
    "TOTAL EMPLOIS": "مجموع الاستعمالات",
    "Apport Personnel (Fonds propres)": "المساهمة الشخصية (أموال ذاتية)",
    "Emprunt Bancaire (Crédit)": "القرض البنكي",
    "Autres financements / subventions": "تمويلات أخرى / إعانات",
    "Trésorerie de départ disponible": "خزينة متوفرة عند الانطلاق",
    "Complément à financer": "مبلغ إضافي يجب تمويله",
...
const RATIO_LABELS_TR = {
  ar: {
    "Marge Nette (Résultat Net / CA)": "الهامش الصافي (الربح الصافي / رقم الأعمال)",
    "Marge d'EBE (EBE / CA)": "هامش الفائض الإجمالي للاستغلال (EBE / رقم الأعمال)",
    "Rentabilité Financière — ROE (RN / Apport)": "المردودية المالية (الربح الصافي / المساهمة الشخصية)",
    "Rentabilité Économique (RN / Investissement)": "المردودية الاقتصادية (الربح الصافي / الاستثمار)",
    "Autonomie Financière (Capitaux Propres / Total Actif)": "الاستقلالية المالية (الأموال الذاتية / مجموع الأصول)",
    "Chiffre d'Affaires par Employé": "رقم الأعمال لكل موظف",
    "Capacité de Remboursement (CAF / annuité moy.)": "القدرة على التسديد (CAF / القسط السنوي المتوسط)",
    "Couverture des Charges Financières (RE / Charges fin.)": "تغطية التكاليف المالية (نتيجة الاستغلال / التكاليف المالية)",
  },
  darija: {
